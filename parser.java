...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\020\000\004\004\006\001\002\000\016\005\010\006" +
    "\014\007\013\010\015\012\012\013\011\001\002\000\004" +
    "\002\007\001\002\000\016\005\ufffa\006\ufffa\007\ufffa\010" +
    "\ufffa\012\ufffa\013\ufffa\001\002\000\004\002\001\001\002" +
    "\000\004\004\006\001\002\000\004\002\000\001\002\000" +
    "\004\004\006\001\002\000\004\004\006\001\002\000\004" +
    "\004\006\001\002\000\004\004\006\001\002\000\016\005" +
    "\ufffc\006\ufffc\007\013\010\015\012\012\013\ufffc\001\002" +
    "\000\016\005\ufffe\006\ufffe\007\013\010\015\012\012\013" +
    "\ufffe\001\002\000\016\005\ufffd\006\ufffd\007\013\010\015" +
    "\012\012\013\ufffd\001\002\000\016\005\ufffb\006\ufffb\007" +
    "\013\010\015\012\012\013\ufffb\001\002\000\016\005\uffff" +
    "\006\uffff\007\013\010\015\012\012\013\uffff\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\020\000\006\002\004\003\003\001\001\000\002\001" +
      ...
      switch (CUP$parser$act_num)
		...
		Integer b = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = a.intValue() * b.intValue(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // expr ::= expr DIVIDIDO expr 
            {
              Integer RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		Integer b = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = a.intValue() / b.intValue(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // expr ::= expr POTENCIA expr 
            {
              Integer RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		int bright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Integer b = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = (int) Math.pow(a.intValue(),  b.intValue()); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("expr",1, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
